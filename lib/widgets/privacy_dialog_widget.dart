...
5. 本政策主要向您说明：
　　a. Cierra_Runis 收集的信息
　　b. Cierra_Runis 如何使用这些信息
...
　　a. Cierra_Runis 产品或服务所需要的必要信息，此类信息为产品或服务正常运行的必备信息，您需授权提供 Cierra_Runis 收集。您有权拒绝 Cierra_Runis 收集。但请悉知这会导致您无法使用 Cierra_Runis 的产品或服务。
　　b. 附加功能可能需要用到的信息，此类信息为非核心功能所需要的信息，您可以授权是否授权 Cierra_Runis 采集。如果您拒绝，可能将会导致您享受的服务无法达到 Cierra_Runis 拟达到的效果，但不影响您对核心功能的正常使用。
...
　　g. 为了帮助您更好地使用 Cierra_Runis 的产品或服务时。
...
　　a. 产品开发和服务优化，当 Cierra_Runis 的系统出现问题发生故障的时候 Cierra_Runis 会记录和分析故障时产生的信息，优化 Cierra_Runis 的服务。
　　b. Cierra_Runis 会用到您的信息在身份验证上，例如您丢失了您的账号寻找客服人员帮助时，客服人员会使用您在注册账号时填写的信息来对您进行身份验证。
　　c. Cierra_Runis 可能会因为版本的迭代来邀请您参与 Cierra_Runis 的服务调查。
...
七、用户信息
1. 总览
　　a. 您可以通过 Cierra_Runis 的服务分享您的相关信息。需注意的地方是，由于 Mercurius 产品的特性，您在使用过程中匹配的对象信息应自觉遵守相应的法律法规，不得在没有经过他人允许的情况下擅自复制、发布、保存他人的敏感信息。
　　b. 您可以通过设置权限来阻止信息的泄露。但请您注意，这些信息仍可能由其他用户或不受 Cierra_Runis 控制的非关联第三方独立地保存。
　　c. 如您发现 Cierra_Runis 违反法律、行政法规的规定或者双方的约定收集、使用您的个人信息，您可以要求 Cierra_Runis 删除。如您发现 Cierra_Runis 收集、存储的您的个人信息有错误的，您也可以要求 Cierra_Runis 更正。
　　d. 请通过本政策列明的联系方式与 Cierra_Runis 联系。请您理解，由于技术所限、法律或监管要求，Cierra_Runis 可能无法满足您的所有要求，Cierra_Runis 会在合理的期限内答复您的请求。
2. 注销账户
　　a. 如您需要注销账户，请您找到注销入口后，提交注销申请。Mercurius 会审核您所发布过的个人信息，确认无相关争议后完成注销。
　　b. 在注销账户之后，Cierra_Runis 将停止为您提供产品或服务，并依据您的要求，删除您的个人信息，但法律法规另有规定的除外。
