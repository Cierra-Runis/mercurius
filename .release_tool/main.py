...
FILE_DIR = {
    ...
    'release_yml': r'.release_tool\mercurius_warehouse\.github\workflows\releases.yml',
    'body_md': r'.release_tool\mercurius_warehouse\body.md',
    'app-arm64-v8a-release_apk': r'build\app\outputs\apk\release\app-arm64-v8a-release.apk',
...
def input_tool(first_message: str, rule: str, error_message: str, rule_function: any) -> str:
    '''
...
def main_module() -> None:
    ...
    if input_str == 'y':
        ...
        copy_file(src_file=FILE_DIR['app-arm64-v8a-release_apk'],
